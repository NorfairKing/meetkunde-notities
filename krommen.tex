...
\begin{st}
  ...
  \begin{proof}
    ...
    \item $\kappa_{\alpha} = \kappa_{\beta}$\\
      ...
      bovendien ori\"entatiebewarend.\gevref{gev:orientatie-isometrie}
  ...
  \begin{proof}
    ...
    \item $\tau_{1} = \tau_{2}$\\
      ...
      \item Kies een willekeurig punt $s_{0}$ uit $I$.  Zij $F$ de
        (unieke!\stref{st:bestaan-isometrie}) isometrie die
        ...
        is bovendien
        ori\"entatiebewarend.\gevref{gev:orientatie-isometrie}

      \item Definieer nu een kromme $\gamma$ als $\gamma=F \circ \alpha$.
        $\gamma$ en $\beta$ zijn dan zeker al gelijk in $s_{0}$.
        We zullen nu aantonen dat $\gamma$ en $\beta$ overal gelijk zijn.
        Merk eerst op dat de kromming en torse van $\gamma$ en $\beta$ al gelijk zijn.
        \[ \kappa_{\gamma} = \kappa_{\beta} \quad\wedge\quad \tau_{\gamma} = \tau_{\beta} \]
      \item We definieren nu de functie $f$:
        \[ f:\ I \rightarrow \mathbb{R}:\ s \mapsto f(s) = T_{\beta}(s) \cdot T_{\gamma}(s) + N_{\beta}(s) \cdot N_{\gamma}(s) + B_{\beta}(s) + B_{\gamma}(s) \]
        Uit de ongelijkheid van Cauchy schwarz volgt dat $f(s)$ voor elke $s\in I$ kleiner is dan of gelijk aan $3$.
        Bovendien is $f(s)$ precies gelijk aan $3$ wanneer $\gamma$ en $\beta$ precies hetzelfde Frenet-Apparaat hebben in $s$.
        \begin{itemize}
        \item In $s_{0}$ is dit al vast het geval.
        \item $f'$ is identiek nul:
          \[
          \begin{array}{rll}
            f' &= (T'_{\beta} \cdot T_{\gamma} + T_{\beta} \cdot T'_{\gamma})\\
               &+ (N'_{\beta}\cdot N_{\gamma} + N_{\beta}\cdot N'_{\gamma})\\ 
               &+ (B'_{\beta} \cdot B_{\gamma} + B_{\beta} \cdot B'_{\gamma})\\
               &= ((\kappa_{\beta}N_{\beta}) \cdot T_{\gamma} + T_{\beta}\cdot (\kappa_{\gamma}N_{\gamma}))\\
               &+ ((-\kappa_{\beta}T_{\beta} + \tau_{\beta}B_{\beta})\cdot N_{\gamma} + N_{\beta}\cdot(-\kappa_{\gamma}T_{\gamma} + \tau_{\gamma}B_{\gamma}))\\
               &+ ((-\tau_{\beta}N_{\beta})\cdot B_{\gamma} + B_{\beta} \cdot (-\tau_{\gamma}N_{\gamma}))\\
               &= 0
          \end{array}
          \]
          Let hier goed op het gebruik van de formules van Frenet.\clarify{waarom is dit nul?!}
        \item Omdat $f$ in $s_{0}$ priecies $3$ is, en constant is, moet $f$ overal $3$ zijn.
        \end{itemize}
      \item Omdat $\beta'$ en $\gamma'$ gelijk zijn, verschillen $\beta$ en $\gamma$ met hoogstens een constante.
        Omdat $\beta$ en $\gamma$ gelijk zijn in $s_{0}$ moet die constante nul zijn.
      \end{itemize}
    \item $\tau_{1} = -\tau_{2}$\\
      \extra{afmaken}
    \end{itemize}
